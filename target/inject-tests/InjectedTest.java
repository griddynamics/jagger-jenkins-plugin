...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/home/amikryukov/git/JENKINS_PLUGIN/jagger-jenkins-plugin");
    parameters.put("artifactId","jagger-jenkins-plugin");
    parameters.put("outputDirectory","/home/amikryukov/git/JENKINS_PLUGIN/jagger-jenkins-plugin/target/classes");
    parameters.put("testOutputDirectory","/home/amikryukov/git/JENKINS_PLUGIN/jagger-jenkins-plugin/target/test-classes");
