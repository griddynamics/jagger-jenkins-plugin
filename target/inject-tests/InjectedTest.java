...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","F:\\Work\\Jenkins_Plugin\\jagger-jenkins-plugin");
    parameters.put("artifactId","jagger-jenkins-plugin");
    parameters.put("outputDirectory","F:\\Work\\Jenkins_Plugin\\jagger-jenkins-plugin\\target\\classes");
    parameters.put("testOutputDirectory","F:\\Work\\Jenkins_Plugin\\jagger-jenkins-plugin\\target\\test-classes");
