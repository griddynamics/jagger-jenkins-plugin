...
public class MasterNode extends Node implements Describable {
    ...
    public MasterNode(String serverAddress, String userName, String sshKeyPath, boolean setJavaHome, String javaHome, String minJavaHeap, String maxJavaHeap, boolean useAdvanced, String javaOptions) {
        super(serverAddress, userName, sshKeyPath, setJavaHome, javaHome, minJavaHeap, maxJavaHeap, useAdvanced, javaOptions);
    }
    ...
    public Descriptor getDescriptor() {
     ...
     @Extension
    public static class DescriptorN extends Descriptor {
